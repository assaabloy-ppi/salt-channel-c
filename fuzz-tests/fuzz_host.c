...
int main(void) {
    ...
    salt_create(&channel, SALT_SERVER, my_write, my_read, NULL);
    ...
    salt_protocols_init(&channel, &my_protocols, protocol_buf, sizeof(protocol_buf));
    salt_protocols_append(&my_protocols, "ECHO", 4);

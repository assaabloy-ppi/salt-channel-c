...
static const uint8_t client_sk_sec[64] = {
...
static const uint8_t client_ek_sec[32] = {
    0x77, 0x07, 0x6d, 0x0a, 0x73, 0x18, 0xa5, 0x7d,
    0x3c, 0x16, 0xc1, 0x72, 0x51, 0xb2, 0x66, 0x45,
    0xdf, 0x4c, 0x2f, 0x87, 0xeb, 0xc0, 0x99, 0x2a,
    0xb1, 0x77, 0xfb, 0xa5, 0x1d, 0xb9, 0x2c, 0x2a
};
static const uint8_t client_ek_pub[32] = {
    0x85, 0x20, 0xf0, 0x09, 0x89, 0x30, 0xa7, 0x54,
    0x74, 0x8b, 0x7d, 0xdc, 0xb4, 0x3e, 0xf7, 0x5a,
    0x0d, 0xbf, 0x3a, 0x0d, 0x26, 0x38, 0x1a, 0xf4,
    0xeb, 0xa4, 0xa9, 0x8e, 0xaa, 0x9b, 0x4e, 0x6a
};
static const uint8_t host_sk_sec[64] = {
...
static salt_ret_t client_io_read(salt_io_channel_t *p_rchannel)
{
    ...
    switch (read_counter) {
        case 0:
            ...
            break;
        case 1:
            memcpy(p_rchannel->p_data, &m2[4], sizeof(m2)-4);
            p_rchannel->size = 38;
            break;
        case 2:
            ...
            break;
        case 3:
            memcpy(p_rchannel->p_data, &m3[4], sizeof(m3)-4);
            p_rchannel->size = 120;
            break;
        default:
            return SALT_ERROR;
...
bool run_client_handshake_benchmark(time_stamps_t *stamps) {
    ...
    salt_create(&channel, SALT_CLIENT, client_io_write, client_io_read, NULL);
    salt_set_signature(&channel, client_sk_sec);

    STAMP_BEGIN(stamps, "salt_handshake_client");
    for (uint16_t i = 0; i < NUM_ITERATIONS; i++) {
        ...
        if (memcmp(&host_sk_sec[32], channel.peer_sk_pub, 32) != 0) {
            retcode = false;
            break;
        }

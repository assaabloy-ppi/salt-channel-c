...
void multimessage(void **state)
{
    ...
    assert_true(host_to_read.messages_count == 3);
    ...
    assert_true(host_ret == SALT_SUCCESS);
    assert_true(host_to_read.messages_count == 2);
    ...
    host_ret = salt_read_next(&host_to_read);
    assert_true(host_ret == SALT_SUCCESS);
    assert_true(host_to_read.messages_count == 1);
    ...
    host_ret = salt_read_next(&host_to_read);
    assert_true(host_ret == SALT_SUCCESS);
    assert_true(host_to_read.messages_count == 0);

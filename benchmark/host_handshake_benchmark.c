...
static salt_ret_t host_io_write(salt_io_channel_t *p_wchannel)
{
...
static salt_ret_t host_io_read(salt_io_channel_t *p_rchannel)
{

    switch (read_counter) {
        case 0:
            memcpy(p_rchannel->p_data, m1, 4);
            p_rchannel->size = 4;
            break;
        case 1:
            memcpy(p_rchannel->p_data, &m1[4], sizeof(m1) - 4);
            p_rchannel->size = sizeof(m1) - 4;
            break;
        case 2:
            ...
            break;
        case 3:
            memcpy(p_rchannel->p_data, &m4[4], sizeof(m4) - 4);
            p_rchannel->size = sizeof(m4) - 4;
            break;
        default:
            return SALT_ERROR;
